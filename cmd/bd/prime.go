...
// primedMemory is a memory entry selected for prime injection: the stored
// content plus the fork-side validity marker (" [EXPIRED]" / " [valid until X]").
...
func renderPrimeMemories(memories map[string]primedMemory, compact bool, maxCount, maxChars int) string {
