...
--
-- The twin of synced migration 0067 (upstream's 0066, re-filed in our fork:
-- bda-vtt1), and required by check D of
...
-- arrives at-latest and 0067 never runs there. Without this file an upgraded
...
--
-- The definition mirrors 0067 exactly: actor is the acting identity the
